...
public class CalParam implements org.apache.thrift.TBase<CalParam, CalParam._Fields>, java.io.Serializable, Cloneable, Comparable<CalParam> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("CalParam");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new CalParamStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new CalParamTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(CalParam.class, metaDataMap);
  }
   ...
   */
  public CalParam(CalParam other) {
  ...
  public CalParam deepCopy() {
    return new CalParam(this);
  }
  ...
  public CalParam setNum1(int num1) {
    this.num1 = num1;
    setNum1IsSet(true);
    return this;
  }
  ...
  public CalParam setNum2(int num2) {
    this.num2 = num2;
    setNum2IsSet(true);
    return this;
  }
   ...
   * @see Operation
   */
  public CalParam setOp(Operation op) {
    this.op = op;
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof CalParam)
      return this.equals((CalParam)that);
    return false;
  }

  public boolean equals(CalParam that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(CalParam other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("CalParam(");
    boolean first = true;
  ...
  private static class CalParamStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public CalParamStandardScheme getScheme() {
      return new CalParamStandardScheme();
    }
  }

  private static class CalParamStandardScheme extends org.apache.thrift.scheme.StandardScheme<CalParam> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, CalParam struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 3: // OP
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.op = com.server.Operation.findByValue(iprot.readI32());
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CalParam struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class CalParamTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public CalParamTupleScheme getScheme() {
      return new CalParamTupleScheme();
    }
  }

  private static class CalParamTupleScheme extends org.apache.thrift.scheme.TupleScheme<CalParam> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, CalParam struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, CalParam struct) throws org.apache.thrift.TException {
